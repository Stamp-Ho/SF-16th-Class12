...
import { ArrowLeft, DiscAlbum, MicVocal, Play, Trash2 } from "lucide-react";
import Link from "next/link";
import RecordModal from "./RecordModal";
import SearchModal from "./SearchModal";
import { addSongRecord, cancelSongRecord, getSongRecords } from "./actions";
...
export default function SongMain({
  ...
  const isAdmin = user.role.includes("song_admin") || user.role.includes("teacher");
